...
<NavigationContainer>
    <UserAuthContext>
        ...
        <Stack.Navigator initialRouteName="AuthHub">
            ...
            <Stack.Screen name="SinglePartAnalasis" component={SinglePartAnalasis}   options={({ route }) => ({ title: route.params.melanomaId.charAt(0).toUpperCase() + route.params.melanomaId.slice(1),headerStyle: { backgroundColor: "#ffff"},headerTintColor: "black" })} />
