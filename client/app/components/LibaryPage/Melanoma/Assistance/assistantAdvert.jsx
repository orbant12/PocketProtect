...
export const AssistantAdvertBox = () => {
    return(
        <View style={{width:"90%",marginTop:20,alignItems:"center",backgroundColor:"black",padding:0,borderRadius:10,flexDirection:"row",height:170}}>
        <View style={{width:130,marginRight:15,padding:10}}>
            ...
            <TouchableOpacity style={{width:"100%",borderWidth:1,padding:6,borderColor:"white",borderRadius:100,alignItems:"center",opacity:0.5,marginTop:20}}>
