...
import { fetchSpotHistory, deleteSpotWithHistoryReset, updateSpot, updateSpotData,fetchSelectedMole } from "../../../services/server";
...
//<==================<[ Functions ]>====================>
    ...
    const fetchAllSpotHistory = async (bPart) => {
        if(currentuser){
            ...
            if (res == "NoHistory"){
                setMelanomaHistory([])
                setHighlighted(formatDate(bPart.created_at))                
            } else if (res == false){
                    ...
                    {selectedMelanoma != null && bodyPart != null &&
                        selectedMelanoma.risk != 0 ?
                            ...
                            <View style={[{marginTop:20,alignItems:"center",width:"100%"}]}>                             
                                ...
                                <View style={[styles.scoreCircle,{borderColor:"red"}]}>
                            ...
                            <View style={[{marginTop:20,alignItems:"center",width:"100%"}]}>                             
                                ...
                                <View style={[styles.scoreCircle,{borderColor:"lightgreen"}]}>
