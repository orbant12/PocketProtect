...
import Svg, { Circle, Path,TextPath,Text,G } from 'react-native-body-highlighter/node_modules/react-native-svg';
    ...
    return (
        <Svg preserveAspectRatio="xMidYMid meet" height={200} width={350} > 
            ...
            {melanomaData.map((data,index) => (
                    data.melanomaDoc.spot.slug == bodyPart.slug && gender == data.gender && (
    ...
    return(
        ...
        transform={
            userData.gender == "male" ? (
                bodyPart.slug == "chest" ? `translate(-190 -270)` 
                :
                ...
                :
                bodyPart.slug == "left-arm(back)" ? `translate(-700 -450)`
                :
                bodyPart.slug == "right-arm(back)" ? `translate(-1150 -300)`
                :
                bodyPart.slug == "gluteal" ? `translate(-925 -570)`
                :
        ...
        scale={
            userData.gender == "male" ? (
                ...
                bodyPart.slug == "back" ? "0.6"
                :
                bodyPart.slug == "left-arm(back)" ? "0.75"
                :
                bodyPart.slug == "right-arm(back)" ? "0.75"
                :
                bodyPart.slug == "gluteal" ? "0.8"
                :
                bodyPart.slug == "right-palm" ? "1.3"
                :
                bodyPart.slug == "left-palm" ? "1.3"
