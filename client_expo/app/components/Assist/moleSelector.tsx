...
const MolesSelectContainerScreen = ({
    ...
    return(
        ...
        <View style={{width:"100%",alignItems:"center"}}>
            <Text style={{alignSelf:"flex-start",fontWeight:"700",margin:10,fontSize:20}}>Highly Recommended</Text>
        ...
        <View style={{width:"100%",alignItems:"center",marginTop:40}}>
            <Text style={{alignSelf:"flex-start",fontWeight:"700",margin:10,fontSize:20}}>Other Moles</Text>
        ...
        <View style={{width:"100%",alignItems:"center",marginTop:40}}>
            <Text style={{alignSelf:"flex-start",fontWeight:"700",margin:10,fontSize:20}}>AI - Risk Analasis Missing</Text>
    ...
    return(
        <View style={[{width:"95%",flexDirection:"row",alignItems:"center",justifyContent:"space-between",padding:10,borderWidth:0.3,marginTop:20,paddingVertical:10,borderRadius:10,backgroundColor:"black"},selectedMoles.includes(data.melanomaId) && {borderWidth:3,borderColor:"magenta"},styles_shadow.shadowContainer]}>
            ...
            <View style={{marginLeft:-20}}>
                ...
                <Text style={{fontWeight:"800",color:"white",fontSize:11,marginTop:5}}>{data.melanomaDoc.spot.slug}</Text>
            </View>
