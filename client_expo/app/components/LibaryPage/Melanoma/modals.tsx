    ...
    return(
        ...
        <View style={SingleSlugStyle.modalBox}>
            <View style={{alignItems:"center",padding:20}}>
                <Text style={{fontWeight:"800",fontSize:18,marginTop:10,textAlign:"center"}}>Are you sure about deleting <Text style={{fontWeight:"700",opacity:0.5,fontSize:13}}>{moleToDelete.storage_name}</Text></Text>
                <View style={{backgroundColor:"lightgray",flexDirection:"column",alignItems:"center",justifyContent:"center",marginTop:20,borderRadius:10}}>
                    <Text style={{fontWeight:"700",fontSize:15,opacity:0.5, padding:10}}>It will be lost forever !</Text>
                </View>
            </View>
            <View style={{flexDirection:"row-reverse",width:"100%",borderTopWidth:1,padding:10,paddingRight:20,height:60}}>
